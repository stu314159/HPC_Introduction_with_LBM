% A streamlined script for using the matlab-GPU LBM tools
...
profile_code = 0; % set to 1 if you want to profile code 
...
%% Get Coordinates for Lattice Points
...
%% Set Lattice Point for Pressure Reference
eps_l = l_conv_fact;
x_pref = 0.5*Lx_p;
y_pref = 0.5*Ly_p;
z_pref = 0.96*Lz_p;
...
%% Identify inlet/outlet and solid nodes
...
%% initialize variables or load restart data
...
% for batch jobs, this is automatically set to 'Y'
run_dec = 'Y';

%% Commence LBM simulation
